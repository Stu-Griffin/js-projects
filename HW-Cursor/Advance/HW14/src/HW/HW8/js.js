...
const a = [(student.studentInfo), (student.studentMarks), (student.getAverageMark), (student.deleteStudent()) ,(student.studentMarks), (student.returnStudent()), (student.studentMarks)]
export default a
