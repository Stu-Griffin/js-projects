...
//   return result;
// }
//если будет "тест" то консоль выбъет "т" как прописную
const a = [getSubjects(students[0]), getAverageMark(students[0]), getStudentInfo(students[0]), getStudentsNames(students), getBestStudent(students)]
export default a 